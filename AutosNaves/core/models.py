...
class Auto(models.Model):
    ...
    img1 = models.ImageField(
        upload_to='imagen especificacion1', blank=True, null=True)
    texto1 = models.CharField(
        max_length=40, verbose_name='especificaciones1', null=True)
    img2 = models.ImageField(
        upload_to='imagen especificacion2', blank=True, null=True)
    texto2 = models.CharField(
        max_length=40, verbose_name='especificaciones2', null=True)
    img3 = models.ImageField(
        upload_to='imagen especificacion3', blank=True, null=True)
    texto3 = models.CharField(
        max_length=40, verbose_name='especificaciones3', null=True)
    img4 = models.ImageField(
        upload_to='imagen especificacion4', blank=True, null=True)
    texto4 = models.CharField(
        max_length=40, verbose_name='especificaciones4', null=True)
